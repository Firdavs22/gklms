...
<div class="relative overflow-hidden rounded-3xl bg-brand p-10 mb-8 text-white shadow-lg overflow-hidden">
    <div class="relative z-10">
        <h1 class="text-3xl font-bold mb-2 tracking-tight">Привет, {{ $user->name }}! 👋</h1>
        <p class="text-white/90 text-lg">Рады видеть вас. Время открыть новые горизонты!</p>
    </div>
...
<div class="px-4 py-8 md:px-0">
    ...
    @if($enrollments->isEmpty())
        ...
        <div class="bg-white rounded-3xl shadow-sm border border-gray-100 p-16 text-center">
            ...
            <h3 class="text-xl font-bold text-gray-900 mb-3">У вас пока нет активных курсов</h3>
            ...
            <a 
                ...
                class="inline-flex items-center px-10 py-5 bg-brand text-white font-bold rounded-2xl hover:opacity-90 transition-all duration-300 shadow-xl shadow-brand/20 active:scale-95"
            >
                Перейти в каталог
            ...
            >
                ...
                <div class="relative aspect-[16/9] bg-gray-100 overflow-hidden">
                    ...
                    <div class="absolute top-4 right-4">
                        <span class="bg-white/90 backdrop-blur-sm text-brand text-[10px] font-bold px-2 py-1 rounded-lg uppercase tracking-wider shadow-sm">Активен</span>
                    </div>
                </div>
                ...
                <div class="p-6 flex flex-col flex-1">
                    <div class="flex items-center space-x-2 mb-3">
                        <span class="bg-gray-100 text-gray-500 text-[9px] font-bold px-2 py-0.5 rounded uppercase tracking-wider">Программа</span>
                    </div>

                    <h3 class="font-bold text-xl text-gray-900 mb-4 group-hover:text-brand transition-colors leading-tight">
                        {{ $course->title }}
                    </h3>
                    ...
                    <div class="mt-auto pt-4">
                        <div class="flex justify-between items-center mb-2">
                            <span class="text-[10px] font-bold uppercase tracking-widest text-gray-400">Прогресс</span>
                            <span class="text-sm font-bold text-brand">{{ $progress }}%</span>
                        </div>
                        <div class="w-full bg-gray-100 rounded-full h-1.5 shadow-inner">
                            <div 
                                class="bg-brand h-1.5 rounded-full transition-all duration-1000 shadow-sm"
                                style="width: {{ $progress }}%"
                            ></div>
                        </div>
                        
                        <div class="mt-5 flex items-center justify-between">
                            <span class="text-[11px] font-medium text-gray-400 flex items-center">
